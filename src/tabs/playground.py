...
def run_task_a_retrieval(
    ...
    output_dir: str = "data/predictions/task_a",
    rewrite_dir: str = "data/predictions/task_a",
...
def run_task_b_generation(
    ...
    output_dir: str = "data/predictions/task_b",
    global_llm_name: str = None,
        ...
        if uploaded_file and run_pipeline:
            try:
                ...
                predictions_path = run_task_a_retrieval(
                    ...
                    output_dir="data/predictions/task_a",
                    rewrite_dir="data/predictions/task_a",
        ...
        if uploaded_file and run_pipeline:
            try:
                ...
                save_path = run_task_b_generation(
                    ...
                    output_dir="data/predictions/task_b",
                    global_llm_name=model_name
                )
        ...
        if uploaded_file and run_pipeline:
            try:
                ...
                predictions_path = run_task_a_retrieval(
                    ...
                    output_dir="data/predictions/task_c/retrieval",
                    rewrite_dir="data/predictions/task_c/retrieval",
                ...
                generation_output_path = run_task_b_generation(
                    ...
                    output_filename_prefix="task_c",
                    output_dir="data/predictions/task_c/generation",
                    global_llm_name=model_name,
