        ...
        with col_sel2:
            ...
            if selected_category == "Task A":
                ...
                if task_a_file:
                    ...
                    uploads_dir = Path("data/evaluation") / "task_a"
            ...
            # --- TASK B/C INPUTS ---
                ...
                judge_provider = st.text_input("Judge Model", value="openai/gpt-oss-20b", help="Model name for LM Studio / HF")
            ...
            if selected_category == "Task A":
                ...
                **Evaluation Configuration:**
                ...
                if task_a_predictions_path:
                    output_path = task_a_predictions_path.replace(".jsonl", "_results.jsonl").replace(".json", "_results.json")
